    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="alert alert-danger check_save" role="alert" style="display: none;">
                <strong>Error ！</strong> 角色不能为空,保存失败.
            </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-sm btn-primary save_role">
...
<div class="alert alert-info save_success"  role="alert" style="display: none;">
    <strong>Success !</strong> 编辑角色成功.
</div>

    <div class="row">    <!-- 表格 开始-->
        <div class="col-xs-12">
            <h3 class="header smaller lighter blue">共有<?php if(!empty($count)): echo ($count); else: ?>0<?php endif; ?>条记录</h3>
            ...
            <div class="table-responsive">
                <table id="files" class="table table-striped table-bordered table-hover" width="100%">
                    ...
                    <?php if(!empty($data)): if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <th class="center"><?php echo ($vo["first_name"]); echo ($vo["last_name"]); ?></th>
                                <th class="center"><?php echo ($vo["email"]); ?></th>
                                <th class="center"><?php echo ($vo["create_time"]); ?></th>

                                <!-- <th class="center"><a href="<?php echo U('Permissions/disRole');?>?uid=<?php echo ($vo["id"]); ?>" class="glyphicon glyphicon-cog" aria-hidden="true">分配角色 </a></th> -->
                                <th class="center"><div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="#" class="disable" data-id="<?php echo ($vo["id"]); ?>">禁用此用户</a></li>
                                        <li class="divider"></li>
                                        <li><a href="#" class="role" data-id="<?php echo ($vo["id"]); ?>" onclick="handleRole(this)">分配角色</a></li>
                                        <li class="divider"></li>
...
<![endif]-->
    ...
    <script type="text/javascript">
        ...
        function handleRole(obj) {
            var url = "<?php echo U('Permissions/disRole');?>";
